...
const OurHero: React.FC<OurHeroProps> = ({
  ...
  className = "",
  teamImages = [
    "https://images.unsplash.com/photo-1494790108755-2616b612b5bc?w=300&h=400&fit=crop&crop=face", // Portrait
    "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=300&fit=crop&crop=face", // Landscape
    "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=300&h=400&fit=crop&crop=face", // Portrait
    "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=350&h=350&fit=crop&crop=face", // Square
    "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=300&fit=crop&crop=face", // Landscape
    "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=400&fit=crop&crop=face", // Portrait
    "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=350&h=350&fit=crop&crop=face", // Square
    "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=300&fit=crop&crop=face"  // Landscape
  ],
  ...
  return (
    ...
    >
      ...
      {/* Decorative elements */}
      <motion.div 
        className="absolute top-10 left-10 w-2 h-2 bg-gray-300 rounded-full opacity-50"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.5, 0.8, 0.5]
        }}
      ...
      />
      <motion.div 
        className="absolute bottom-10 right-10 w-3 h-3 bg-gray-400 rounded-full opacity-30"
        animate={{
          scale: [1, 0.8, 1],
          opacity: [0.3, 0.6, 0.3]
        }}
